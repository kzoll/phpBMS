...
INSERT INTO `tablefindoptions` (`tabledefid`, `name`, `search`, `displayorder`, `roleid`) VALUES ('tbld:0fcca651-6c34-c74d-ac04-2d88f602dd71', 'My Events - Yesterday', 'notes.type=\'EV\' AND notes.createdby = {{$_SESSION[\'userinfo\'][\'id\']}} AND ((notes.startdate = date_sub(curdate(),INTERVAL
##### v1
DAY)) OR notes.`repeat`=1)', '2', '');
...
INSERT INTO `tablefindoptions` (`tabledefid`, `name`, `search`, `displayorder`, `roleid`) VALUES ('tbld:0fcca651-6c34-c74d-ac04-2d88f602dd71', 'My Events - Tomorrow', 'notes.type=\'EV\' AND notes.createdby = {{$_SESSION[\'userinfo\'][\'id\']}} AND (notes.startdate = date_add(curdate(),INTERVAL
##### v1
DAY) OR notes.repeat=1)', '3', '');
INSERT INTO `tablefindoptions` (`tabledefid`, `name`, `search`, `displayorder`, `roleid`) VALUES ('tbld:0fcca651-6c34-c74d-ac04-2d88f602dd71', 'My Events - Next Month', 'notes.type=\'EV\' AND notes.createdby = {{$_SESSION[\'userinfo\'][\'id\']}} AND ((year(notes.startdate)=year(date_add(curdate(),INTERVAL
##### v1
MONTH)) and month(notes.startdate)=month(date_add(curdate(),INTERVAL
##### v1
MONTH))) OR notes.repeat=1)', '7', '');
INSERT INTO `tablefindoptions` (`tabledefid`, `name`, `search`, `displayorder`, `roleid`) VALUES ('tbld:0fcca651-6c34-c74d-ac04-2d88f602dd71', 'My Events - Next Week', 'notes.type=\'EV\' AND notes.createdby = {{$_SESSION[\'userinfo\'][\'id\']}} AND ((notes.startdate = year(notes.startdate)=year(date_add(curdate(),INTERVAL
##### v1
WEEK)) and week(notes.startdate)=week(date_add(curdate(),INTERVAL
##### v1
WEEK))) OR notes.repeat=1)', '5', '');
...
INSERT INTO `tablefindoptions` (`tabledefid`, `name`, `search`, `displayorder`, `roleid`) VALUES ('tbld:0fcca651-6c34-c74d-ac04-2d88f602dd71', 'Public Events - Yesterday', 'notes.type=\'EV\' AND notes.private=0 AND ((notes.startdate = date_sub(curdate(),INTERVAL
##### v1
DAY)) OR notes.repeat=1)', '10', '');
INSERT INTO `tablefindoptions` (`tabledefid`, `name`, `search`, `displayorder`, `roleid`) VALUES ('tbld:0fcca651-6c34-c74d-ac04-2d88f602dd71', 'Public Events - Tomorrow', 'notes.type=\'EV\' AND notes.private=0 AND (notes.startdate = date_add(curdate(),INTERVAL
##### v1
DAY) OR notes.repeat=1)', '11', '');
...
INSERT INTO `tablefindoptions` (`tabledefid`, `name`, `search`, `displayorder`, `roleid`) VALUES ('tbld:0fcca651-6c34-c74d-ac04-2d88f602dd71', 'Public Events - Next Week', 'notes.type=\'EV\' AND notes.private=0 AND ((notes.startdate = year(notes.startdate)=year(date_add(curdate(),INTERVAL
##### v1
WEEK)) and week(notes.startdate)=week(date_add(curdate(),INTERVAL
##### v1
WEEK))) OR notes.repeat=1)', '13', '');
...
INSERT INTO `tablefindoptions` (`tabledefid`, `name`, `search`, `displayorder`, `roleid`) VALUES ('tbld:0fcca651-6c34-c74d-ac04-2d88f602dd71', 'Public Events - Next Month', 'notes.type=\'EV\' notes.private=0 AND ((year(notes.startdate)=year(date_add(curdate(),INTERVAL
##### v1
MONTH)) and month(notes.startdate)=month(date_add(curdate(),INTERVAL
##### v1
MONTH))) OR notes.repeat=1)', '15', '');
...
INSERT INTO `tablefindoptions` (`tabledefid`, `name`, `search`, `displayorder`, `roleid`) VALUES ('tbld:3f71ab66-1f84-d68b-e2a3-3ee3bb0ec667', 'entries within last day', 'log.stamp> DATE_SUB(CURDATE(),INTERVAL
##### v1
DAY)', '0', '');
INSERT INTO `tablefindoptions` (`tabledefid`, `name`, `search`, `displayorder`, `roleid`) VALUES ('tbld:3f71ab66-1f84-d68b-e2a3-3ee3bb0ec667', 'entries within last week', 'log.stamp> DATE_SUB(CURDATE(),INTERVAL
##### v1
WEEK)', '1', '');
