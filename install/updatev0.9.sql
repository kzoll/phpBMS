...
DELETE FROM tablegroupings WHERE tabledefid=9 or tabledefid=10 or tabledefid =
##### v11
or tabledefid =
##### v12
OR tabledefid =
...
INSERT INTO `tablegroupings` (`tabledefid`, `field`, `displayorder`, `ascending`, `name`, `roleid`) VALUES (23,'ELT(notes.importance+3,\'6 - Lowest\',\'
##### v5
- Low\',\'4 - Normal\',\"3 - Medium\",\'2 - High\',\'1 - Highest\')',1,1,'Importance',0);
...
INSERT INTO `menu` (`id`, `name`, `link`, `parentid`, `displayorder`, `createdby`, `modifiedby`, `creationdate`, `modifieddate`, `roleid`) VALUES ('14', 'Saved Searches/Sorts', 'search.php?id=17', '6', '40', '1', '1', NOW(), NOW(), '-100');
