...
INSERT INTO `tablefindoptions` (`tabledefid`, `name`, `search`, `displayorder`, `roleid`) VALUES ('tbld:380d4efa-a825-f377-6fa1-a030b8c58ffe', 'All Records', 'paymentmethods.id!=-1', '2', '');
...
INSERT INTO `tablefindoptions` (`tabledefid`, `name`, `search`, `displayorder`, `roleid`) VALUES ('tbld:455b8839-162b-3fcb-64b6-eeb946f873e1', 'all records', 'discounts.id!=0', '0', '');
...
INSERT INTO `tablefindoptions` (`tabledefid`, `name`, `search`, `displayorder`, `roleid`) VALUES ('tbld:62fe599d-c18f-3674-9e54-b62c2d6b1883', 'Invoices', 'invoices.type=\"Invoice\"', '11', 'role:259ead9f-100b-55b5-508a-27e33a6216bf');
...
INSERT INTO `tablefindoptions` (`tabledefid`, `name`, `search`, `displayorder`, `roleid`) VALUES ('tbld:62fe599d-c18f-3674-9e54-b62c2d6b1883', 'All Credit Memos', '`invoices`.`iscreditmemo` != \'0\'', '21', 'role:259ead9f-100b-55b5-508a-27e33a6216bf');
INSERT INTO `tablefindoptions` (`tabledefid`, `name`, `search`, `displayorder`, `roleid`) VALUES ('tbld:6d290174-8b73-e199-fe6c-bcf3d4b61083', 'Prospects', 'clients.type = \"prospect\"   and clients.inactive=0', '1', '');
INSERT INTO `tablefindoptions` (`tabledefid`, `name`, `search`, `displayorder`, `roleid`) VALUES ('tbld:6d290174-8b73-e199-fe6c-bcf3d4b61083', 'Today\'s Prospects', 'clients.type = \"prospect\" and (TO_DAYS(now())-TO_DAYS(clients.creationdate))=0 and clients.inactive=0', '3', '');
INSERT INTO `tablefindoptions` (`tabledefid`, `name`, `search`, `displayorder`, `roleid`) VALUES ('tbld:6d290174-8b73-e199-fe6c-bcf3d4b61083', 'Yesterday\'s Prospects', 'clients.type = \"prospect\" and (TO_DAYS(now())-TO_DAYS(clients.creationdate))=1 and clients.inactive=0', '4', '');
INSERT INTO `tablefindoptions` (`tabledefid`, `name`, `search`, `displayorder`, `roleid`) VALUES ('tbld:6d290174-8b73-e199-fe6c-bcf3d4b61083', 'Last Week\'s Prospects', 'clients.type = \"prospect\" and (TO_DAYS(now())-TO_DAYS(clients.creationdate))<7 and clients.inactive=0', '5', '');
INSERT INTO `tablefindoptions` (`tabledefid`, `name`, `search`, `displayorder`, `roleid`) VALUES ('tbld:6d290174-8b73-e199-fe6c-bcf3d4b61083', 'Clients', 'clients.type = \"client\" and clients.inactive=0', '0', '');
INSERT INTO `tablefindoptions` (`tabledefid`, `name`, `search`, `displayorder`, `roleid`) VALUES ('tbld:6d290174-8b73-e199-fe6c-bcf3d4b61083', 'Inactive Clients', 'clients.type = \"client\" and clients.inactive=1', '6', '');
INSERT INTO `tablefindoptions` (`tabledefid`, `name`, `search`, `displayorder`, `roleid`) VALUES ('tbld:6d290174-8b73-e199-fe6c-bcf3d4b61083', 'All Records', 'clients.id != 0', '7', '');
INSERT INTO `tablefindoptions` (`tabledefid`, `name`, `search`, `displayorder`, `roleid`) VALUES ('tbld:7a9e87ed-d165-c4a4-d9b9-0a4adc3c5a34', 'In Stock Items', 'products.status=\"In Stock\"', '1', '');
INSERT INTO `tablefindoptions` (`tabledefid`, `name`, `search`, `displayorder`, `roleid`) VALUES ('tbld:7a9e87ed-d165-c4a4-d9b9-0a4adc3c5a34', 'Out of Stock Items', 'products.status=\"Out of Stock\"', '2', '');
INSERT INTO `tablefindoptions` (`tabledefid`, `name`, `search`, `displayorder`, `roleid`) VALUES ('tbld:7a9e87ed-d165-c4a4-d9b9-0a4adc3c5a34', 'Backordered Items', 'products.status=\"Backordered\"', '3', '');
INSERT INTO `tablefindoptions` (`tabledefid`, `name`, `search`, `displayorder`, `roleid`) VALUES ('tbld:7a9e87ed-d165-c4a4-d9b9-0a4adc3c5a34', 'Inactive', 'products.inactive=1', '4', '');
INSERT INTO `tablefindoptions` (`tabledefid`, `name`, `search`, `displayorder`, `roleid`) VALUES ('tbld:7a9e87ed-d165-c4a4-d9b9-0a4adc3c5a34', 'All Records', 'products.id != 0', '5', '');
...
INSERT INTO `tablefindoptions` (`tabledefid`, `name`, `search`, `displayorder`, `roleid`) VALUES ('tbld:c595dbe7-6c77-1e02-5e81-c2e215736e9c', 'non-posted', 'aritems.posted = 0', '2', '');
INSERT INTO `tablefindoptions` (`tabledefid`, `name`, `search`, `displayorder`, `roleid`) VALUES ('tbld:c9ff2c8c-ce1f-659a-9c55-31bca7cce70e', 'All Records', 'tax.id != 0', '3', '');
INSERT INTO `tablefindoptions` (`tabledefid`, `name`, `search`, `displayorder`, `roleid`) VALUES ('tbld:c9ff2c8c-ce1f-659a-9c55-31bca7cce70e', 'Active Records', 'tax.inactive=0', '1', '');
INSERT INTO `tablefindoptions` (`tabledefid`, `name`, `search`, `displayorder`, `roleid`) VALUES ('tbld:c9ff2c8c-ce1f-659a-9c55-31bca7cce70e', 'Inactive Records', 'tax.inactive=1', '2', '');
INSERT INTO `tablefindoptions` (`tabledefid`, `name`, `search`, `displayorder`, `roleid`) VALUES ('tbld:d6e4e1fb-4bfa-cb53-ab9c-1b3e7f907ae2', 'Active Records', 'invoicestatuses.inactive=0', '0', '');
INSERT INTO `tablefindoptions` (`tabledefid`, `name`, `search`, `displayorder`, `roleid`) VALUES ('tbld:d6e4e1fb-4bfa-cb53-ab9c-1b3e7f907ae2', 'All Records', 'invoicestatuses.id!=-1', '1', '');
INSERT INTO `tablefindoptions` (`tabledefid`, `name`, `search`, `displayorder`, `roleid`) VALUES ('tbld:e3ce122f-7c43-cfca-fd32-11c663567a2a', 'All Records', 'addresstorecord.id!=-1', '0', '');
INSERT INTO `tablefindoptions` (`tabledefid`, `name`, `search`, `displayorder`, `roleid`) VALUES ('tbld:f993cf23-ad4a-047b-e920-d45fee1dc08e', 'match names', 'clients.firstname=dclients.firstname AND clients.lastname=dclients.lastname AND clients.lastname != \'\' AND clients.firstname != \'\' AND  clients.id<>dclients.id', '1', '');
INSERT INTO `tablefindoptions` (`tabledefid`, `name`, `search`, `displayorder`, `roleid`) VALUES ('tbld:f993cf23-ad4a-047b-e920-d45fee1dc08e', 'match names and postal code', 'clients.firstname=dclients.firstname AND clients.lastname=dclients.lastname AND addresses.postalcode = daddresses.postalcode AND clients.lastname != \'\' AND clients.firstname != \'\' AND addresses.postalcode != \'\' AND clients.id<>dclients.ID', '2', '');
INSERT INTO `tablefindoptions` (`tabledefid`, `name`, `search`, `displayorder`, `roleid`) VALUES ('tbld:f993cf23-ad4a-047b-e920-d45fee1dc08e', 'match addresses', 'addresses.address1=daddresses.address1 AND clients.id<>dclients.id', '3', '');
INSERT INTO `tablefindoptions` (`tabledefid`, `name`, `search`, `displayorder`, `roleid`) VALUES ('tbld:fa8a0ddc-87d3-a9e9-60b0-1bab374b2993', 'All Records', 'shippingmethods.id!=-1', '2', '');
INSERT INTO `tablefindoptions` (`tabledefid`, `name`, `search`, `displayorder`, `roleid`) VALUES ('tbld:fa8a0ddc-87d3-a9e9-60b0-1bab374b2993', 'Active Records', 'shippingmethods.inactive=0', '0', '');
INSERT INTO `tablefindoptions` (`tabledefid`, `name`, `search`, `displayorder`, `roleid`) VALUES ('tbld:fa8a0ddc-87d3-a9e9-60b0-1bab374b2993', 'Inactive Records', 'shippingmethods.inactive=1', '1', '');
